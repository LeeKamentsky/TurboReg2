 ...
 *
 * The TurboRegInterval acts as a common base class for TurboRegImage and TurboRegMask, supplying
 * some code that's generally useful in bridging ImageJ 2 to the TurboReg infrastructure.
 */
class TurboRegInterval<PYRAMID_TYPE> {
    ...
    /**
     * *******************************************************************
     * Return the depth of the image pyramid. A depth <code>1</code> means that one coarse
     * resolution level is present in the stack. The full-size level is not placed on the stack.
	 *******************************************************************
     */
    ...
    /**
     * The execution context is the parent process or command that is using this
     * <code>TurboRegImage</code>. The parent may be canceled at any point and this will cause
     * processing in the <code>TurboRegImage</code> to abort
     *
    ...
    /**
     * @return true if the parent execution context (if any) has been canceled.
     */
     ...
     * The organization of the stack depends on whether the pyramid is a <code>TurboRegImage</code>
     * or <code>TurboRegMask</code> pyramid.
     * <br>
     * <em>TurboRegImage organization</em><br>
     * The <code>TurboRegImage</code> object corresponds to the target or the source image, and on
     * the transformation (ML* = {<code>TRANSLATION</code>,<code>RIGID_BODY</code>,
     * <code>SCALED_ROTATION</code>, <code>AFFINE</code>} vs. ML = {<code>BILINEAR<code>}). A single pyramid level consists of
     * <p>
     * <table border="1">
     ...
     * A single pyramid level consists of
     * <p>
     * <table border="1">
     * <tr><th><code>isTarget</code></th>
     * <th>ML*</th>
    ...
    /**
     * Compute the number of pyramid planes to compute given the source and target image dimensions
     *
     * @return
